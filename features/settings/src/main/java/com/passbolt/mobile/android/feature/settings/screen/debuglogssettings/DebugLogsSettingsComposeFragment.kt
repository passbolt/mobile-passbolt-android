...
class DebugLogsSettingsComposeFragment :
    Fragment(),
    DebugLogSettingsNavigation {
            ...
            setContent {
                PassboltTheme {
                    DebugLogsSettingsScreen(
                        navigation = this@DebugLogsSettingsComposeFragment,
                    )
                }
            }
        }
    ...
    override fun navigateToLogs() {
        findNavController().navigate(
            DebugLogsSettingsComposeFragmentDirections.actionDebugLogsSettingsComposeFragmentToLogs(),
        )
    }
    ...
    override fun openHelpWebsite() {
        externalDeeplinkHandler.openWebsite(
            ...
            url = getString(LocalizationR.string.help_website),
        )
    }
}
