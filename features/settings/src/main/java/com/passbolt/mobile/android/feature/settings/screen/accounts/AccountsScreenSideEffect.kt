...
internal sealed interface AccountsScreenSideEffect {
    ...
    data object NavigateToKeyInspector : AccountsScreenSideEffect

    data object NavigateToManageAccounts : AccountsScreenSideEffect

    data object NavigateToTransferAccount : AccountsScreenSideEffect
}
