...
class DescriptionFormComposeFragment :
    Fragment(),
    DescriptionFormNavigation {
    private val navArgs: DescriptionFormComposeFragmentArgs by navArgs()
            ...
            setContent {
                PassboltTheme {
                    DescriptionFormScreen(
                        navigation = this@DescriptionFormComposeFragment,
                        viewModel =
                            koinViewModel(
                                parameters = { parametersOf(navArgs.mode, navArgs.metadataDescription) },
                            ),
                    )
                }
            }
    ...
    override fun navigateBackWithResult(metadataDescription: String) {
        setFragmentResult(
