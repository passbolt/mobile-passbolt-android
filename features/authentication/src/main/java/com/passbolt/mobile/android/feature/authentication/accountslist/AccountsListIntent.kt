...
sealed interface AccountsListIntent {
    ...
    data object AddAccount : AccountsListIntent

    data object EnterRemoveAccountMode : AccountsListIntent

    data object ExitRemoveAccountMode : AccountsListIntent
    ...
    data object DismissRemoveAccountDialog : AccountsListIntent

    data object GoBack : AccountsListIntent
}
