...
import com.passbolt.mobile.android.createresourcemenu.compose.CreateResourceMenuViewModel
...
val createResourceMenuModule =
    module {
        ...
        viewModelOf(::CreateResourceMenuViewModel)
    }
