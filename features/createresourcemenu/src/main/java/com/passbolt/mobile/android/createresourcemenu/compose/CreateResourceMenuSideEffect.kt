...
sealed interface CreateResourceMenuSideEffect {
    data object InvokeCreatePassword : CreateResourceMenuSideEffect

    data object InvokeCreateTotp : CreateResourceMenuSideEffect
