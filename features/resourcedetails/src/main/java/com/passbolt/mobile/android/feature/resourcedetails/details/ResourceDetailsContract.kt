...
interface ResourceDetailsContract {
    ...
    interface View : DataRefreshViewReactiveContract.View {
        ...
        fun clearSecureNoteInput()
        fun disableSecureNote()
    ...
    interface Presenter : DataRefreshViewReactiveContract.Presenter<View> {
        fun argsReceived(resourceModel: ResourceModel, permissionsListWidth: Int, permissionItemWidth: Float)
        ...
        fun totpIconClick()
        fun copyTotpClick()
        fun copySecureNoteClick()
        fun secureNoteActionClick()
    }
}
