...
class PasswordAndDescriptionSecretValidation {

    fun invoke(secret: DecryptedSecret.PasswordWithDescription): Boolean {
        val validationResults = listOf(
            RequiredStringLengthValidation().invoke(
                secret.password,
                PASSWORD_AND_DESCRIPTION_PASSWORD_MIN_LENGTH,
                PASSWORD_AND_DESCRIPTION_PASSWORD_MAX_LENGTH
            ),
            OptionalStringLengthValidation().invoke(
                secret.description,
                PASSWORD_AND_DESCRIPTION_DESCRIPTION_MIN_LENGTH,
                PASSWORD_AND_DESCRIPTION_DESCRIPTION_MAX_LENGTH
            )
        )
