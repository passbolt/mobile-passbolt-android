    ...
    init {
        ...
        map[v5PasswordString] =
            listOf(
                ...
                ResourceTypeEdge(v5PasswordString, v5PasswordString, UpdateAction.EDIT_ADDITIONAL_URIS),
                ResourceTypeEdge(v5PasswordString, v5PasswordString, UpdateAction.EDIT_APPEARANCE),
            )
