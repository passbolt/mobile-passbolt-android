...
class ResourcePermissionsPresenterTest : KoinTest {
    ...
    fun `save button and add user button should be shown in edit mode`() {
        presenter.argsReceived(PermissionsItem.RESOURCE, RESOURCE_ID, ResourcePermissionsMode.EDIT)
    ...
    fun `edit button should be shown in view mode and if owner`() {
        ...
        presenter.argsReceived(PermissionsItem.RESOURCE, RESOURCE_ID, ResourcePermissionsMode.VIEW)
