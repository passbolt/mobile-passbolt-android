...
import com.passbolt.mobile.android.dto.serializer.gson.BooleanStrictTypeAdapter
...
class BooleanStrictTypeAdapterTest {
    ...
    private data class TestModel(val testField: Boolean)

    private val gson = GsonBuilder()
        .registerTypeAdapter(Boolean::class.java, BooleanStrictTypeAdapter())
        .create()
