...
import com.passbolt.mobile.android.dto.serializer.gson.StringStrictTypeAdapter
...
class StringStrictTypeAdapterTest {
    ...
    private data class TestModel(val testField: String)

    private val gson = GsonBuilder()
        .registerTypeAdapter(String::class.java, StringStrictTypeAdapter())
        .create()
